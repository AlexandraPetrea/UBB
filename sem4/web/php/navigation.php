...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo $home_url; ?>">Razvi's Site</a>
        </div>
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li <?php
                    ...
                    <a href="<?php echo $home_url; ?>read_news_date.php">News by date</a>
                </li>
                <li <?php
                        echo $page_title=="News by category" ? "class='active'" : ""; ?> >
                    <a href="<?php echo $home_url; ?>read_news_category.php">News by category</a>
                </li>
            </ul>
