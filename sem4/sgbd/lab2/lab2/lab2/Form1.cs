...
namespace lab2
    {
        public partial class Form1 : Form
        {
            ...
            private string childTableName = System.Configuration.ConfigurationManager.AppSettings["ChildTableName"];
            ...
            {
                string select = System.Configuration.ConfigurationManager.AppSettings["SelectParent"];
            ...
            {
                string parentId = (string)dataGridViewParent.CurrentRow.Cells[0].Value;
            ...
            private void addButton_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@id", (string)dataGridViewParent.CurrentRow.Cells[0].Value);
                    //MessageBox.Show((string)dataGridViewParent.CurrentRow.Cells[0].Value);
            ...
            private void deleteButton_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@id", (string)dataGridViewChild.CurrentRow.Cells[0].Value);
                    SqlDataAdapter daChild = new SqlDataAdapter(cmd);
                    DataSet dataSet = new DataSet();
                    connection.Open();
                    cmd.ExecuteNonQuery();
