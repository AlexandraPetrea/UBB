...
class UI:
	def __init__(self, bookController, clientController, rentalController, undoController, validator, redoController):
		...
		while True:
			...
			if userInput == "1":
				...
				if opType == '1':
					...
					self.__bookController.add(book)
					...
					self.__clientController.add(client)
