...
class BookController:
	...
	def undo(self):
		...
		if isinstance(operation, AddOperation):
			...
			self._bookController.add(operation.getObject())
		else:
			self._bookController.Updateid(operation.getUpdatedObject(),operation.getOldObject())
	...
	def find1(self, index):
		...
		for e in range(0, len(self._repo)):
			...
			if int(self._repo.get(e)[0]) == int(index):
				#print(self._repo.get(e)[0])
				return e
		return None
