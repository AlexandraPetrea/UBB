...
class RentalController:
    ...
    def getSortedClients(self):
        ...
        for i in range(0, len(self._repo)):
            ...
            rental_date = self._repo.get(i)[2]
            return_date = self._repo.get(i)[3]
        ...
        '''
        #sorted_clients = shellSort(sorted_clients, lambda x:x.getName())
        sorted_clients = shellSort(sorted_clients, lambda x: x.getName())
    ...
    def getLateRentals(self):
        ...
        '''
        late_rentals = shellSort(late_rentals)
