...
public class Test_ListEmotions {
    ...
    @Test
    public void Test_FirstAndLast_predominantEmotion() {
        System.out.println("Test .... Test_FirstAndLast_predominantEmotion ... ");
        List<Emotion> testLstEmotions = new ArrayList<Emotion>();
        List lEmotions = new ArrayList<Emotion>();
        Emotion eJ = new Emotion("Joy", EmotionType.Joy);
        lEmotions.add(eJ);
        ...
        assertEquals(result.get(0).getEmotionType(), EmotionType.Joy);
        assertEquals(result.size(), 1);
    }
    @Test
    public void Test_NoPredominantEmotion_predominantEmotion() {
        System.out.println("Test .... Test_NoPredominantEmotion_predominantEmotion ... ");
        List<Emotion> testLstEmotions = new ArrayList<Emotion>();
        List lEmotions = new ArrayList<Emotion>();
        Emotion eJ = new Emotion("Joy", EmotionType.Joy);
        lEmotions.add(eJ);
        ...
        List<Emotion> result = le.predominantEmotion();
        assertEquals(result.get(0).getEmotionType(), EmotionType.Joy);
        assertEquals(result.get(1).getEmotionType(), EmotionType.Anger);
        assertEquals(result.get(2).getEmotionType(), EmotionType.Sadness);
        assertEquals(result.get(3).getEmotionType(), EmotionType.Disgust);
        assertEquals(result.get(4).getEmotionType(), EmotionType.Fear);
        assertEquals(result.size(), 5);
    }
    @Test
    public void Test_TwoPredominantEmotionDoubleAppFirstLast_predominantEmotion() {
        System.out.println("Test .... Test_PredominantEmotionDoubleAppFirstAndLast_predominantEmotion ... ");
        List<Emotion> testLstEmotions = new ArrayList<Emotion>();
        List lEmotions = new ArrayList<Emotion>();
        Emotion eJ = new Emotion("Joy", EmotionType.Joy);
        lEmotions.add(eJ);
        ...
        List<Emotion> result = le.predominantEmotion();
        assertEquals(result.get(0).getEmotionType(), EmotionType.Joy);
        assertEquals(result.get(1).getEmotionType(), EmotionType.Fear);
        assertEquals(result.size(), 2);
    }


    @Test
    public void Test_OneEmotionTwoAppearances_predominantEmotion() {
        System.out.println("Test .... Test_OneEmotionTwoAppearances_predominantEmotion ... ");
        List<Emotion> testLstEmotions = new ArrayList<Emotion>();
        List lEmotions = new ArrayList<Emotion>();
        Emotion eJ = new Emotion("Joy", EmotionType.Joy);
        lEmotions.add(eJ);
    ...
    @Test
    public void Test_EmptyEmotionList_predominantEmotion() {
        System.out.println("Test .... Test_EmptyEmotionList_predominantEmotion ... ");
        List<Emotion> testLstEmotions = new ArrayList<Emotion>();
        ListEmotions le = new ListEmotions(new ArrayList<Emotion>());
        List<Emotion> result = le.predominantEmotion();
