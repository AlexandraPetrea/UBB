            ...
            using (new MPI.Environment(ref args))
            {
                ...
                if (Communicator.world.Rank == 0)
                {
                    ...
                    while (!exit)
                    {
                        ...
                        {
                            Console.WriteLine("Type which variable you want to change (a or b or c) = ");
                            string var = Console.ReadLine();

                            Console.WriteLine("Give the value (int) = ");
                            int val;
                        ...
                        {
                            Console.WriteLine("Give the variable you want to check (a, b, c) = ");
                            string var = Console.ReadLine();

                            Console.WriteLine("The value to be checked (int) = ");
                            int val;
                            int.TryParse(Console.ReadLine(), out val);

                            Console.WriteLine("The new value (int) = ");
                            int newVal;
